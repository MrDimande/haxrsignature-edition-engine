...
export const STAN_ASSETS_MANIFEST: StanAssetSpec[] = [
  ...
  },
  {
    ...
    purpose: "Acto III — Stan a sorrir (momento marcado)",
    orientation: "portrait",
    aspectRatio: "3:4",
  ...
  },
  {
    ...
    purpose: "Acto III — Stan a brincar com pneu (marcado)",
    orientation: "portrait",
    aspectRatio: "3:4",
    minResolution: "800×1000",
    mobileVariantRequired: false,
  ...
  },
  {
    ...
    purpose: "Acto III — Stan no pátio (marcado)",
    orientation: "portrait",
    aspectRatio: "3:4",
    minResolution: "800×1000",
    mobileVariantRequired: false,
  ...
  {
    id: "chapter-04-primary2",
    file: "/images/stan/story/chapter-04/primary2.png",
    purpose: "Acto IV — STANLEY 10 no campo",
    orientation: "portrait",
    aspectRatio: "3:4",
  ...
  {
    id: "idol-stan",
    file: "/images/stan/idols/stanley.png",
    purpose: "Retrato central do Stanley na secção de ídolos (dominante)",
    orientation: "portrait",
    aspectRatio: "3:4",
    minResolution: "1200×1600",
    mobileVariantRequired: false,
    ...
    status: "received",
    notes: "Camisola Real Madrid, braços cruzados — dominante face aos ídolos",
  },
  {
    id: "idol-mbappe",
